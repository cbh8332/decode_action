/**************************************
@Name stlxz 签到 积分可以兑换3d打印模型
@Author：Sliverkiss
@Date：2023-10-21 19:01:56

2023.11.06 移除登录接口，使用ck形式，以避免风控问题。

网址入口：https://www.stlxz.com?ref=10606

使用方法：将账号和用户名用#拼接，如账号#密码，填写到stlxz_data，多账号用 & 分隔(已失效)

[Script]
cron "30 8 * * *" script-path=stlxz.js, timeout=300, tag=STLXZ
http-request ^https:\/\/www.stlxz.com\/user\/balance script-path=stlxz.js, timeout=10, tag=STLXZ获取token
[MITM]
...
//Sun Jun 30 2024 03:34:35 GMT+0000 (Coordinated Universal Time)
...
function DoubleLog(_0x2ebd7c) {
  if ($.isNode()) {
    _0x2ebd7c && (console.log("" + _0x2ebd7c), $.notifyMsg.push("" + _0x2ebd7c));
  } else {
...
function debug(_0xebba13) {
  if ($.is_debug === "true") {
    if (typeof _0xebba13 == "string") {
      ...
      typeof _0xebba13 == "object" && console.log($.toStr(_0xebba13));
    }
  }
}
async function checkEnv() {
  if (userCookie) {
    ...
    for (let _0x219a27 of userCookie.split(_0xe7fd)) _0x219a27 && userList.push(new UserInfo(_0x219a27));
...
function Env(_0x34642e, _0x4eb72a) {
  class _0x17482e {
    ...
    send(_0x5e813f, _0x56f1b9 = "GET") {
      _0x5e813f = "string" == typeof _0x5e813f ? {
        url: _0x5e813f
      } : _0x5e813f;
      let _0x2a9ee2 = this.get;
      "POST" === _0x56f1b9 && (_0x2a9ee2 = this.post);
  ...
  return new class {
    ...
    runScript(_0x2b0681, _0x1407b0) {
      return new Promise(_0x59f894 => {
        ...
        _0x25bebc = _0x25bebc ? 1 * _0x25bebc : 20;
        _0x25bebc = _0x1407b0 && _0x1407b0.timeout ? _0x1407b0.timeout : _0x25bebc;
        const _0x39f693 = {
    ...
    lodash_get(_0x1e8560, _0x3f2c3d, _0x5ab528) {
      ...
      for (const _0x41f497 of _0x56a285) if (_0x36c4c0 = Object(_0x36c4c0)[_0x41f497], void 0 === _0x36c4c0) {
        return _0x5ab528;
      }
      return _0x36c4c0;
    }
    lodash_set(_0x4227de, _0x28d879, _0x4f3e2f) {
      return Object(_0x4227de) !== _0x4227de ? _0x4227de : (Array.isArray(_0x28d879) || (_0x28d879 = _0x28d879.toString().match(/[^.[\]]+/g) || []), _0x28d879.slice(0, -1).reduce((_0x5cd6ae, _0x167ff2, _0x6843bd) => Object(_0x5cd6ae[_0x167ff2]) === _0x5cd6ae[_0x167ff2] ? _0x5cd6ae[_0x167ff2] : _0x5cd6ae[_0x167ff2] = Math.abs(_0x28d879[_0x6843bd + 1]) >> 0 == +_0x28d879[_0x6843bd + 1] ? [] : {}, _0x4227de)[_0x28d879[_0x28d879.length - 1]] = _0x4f3e2f, _0x4227de);
    }
    getdata(_0x117b4d) {
      ...
      if (/^@/.test(_0x117b4d)) {
        ...
        if (_0x4391db) {
          try {
            ...
            _0x4d1e93 = _0x2601a0 ? this.lodash_get(_0x2601a0, _0x3d523b, "") : _0x4d1e93;
          } catch (_0xacf23e) {
            _0x4d1e93 = "";
          }
        }
    ...
    initGotEnv(_0x1cb476) {
      ...
      _0x1cb476 && (_0x1cb476.headers = _0x1cb476.headers ? _0x1cb476.headers : {}, void 0 === _0x1cb476.headers.Cookie && void 0 === _0x1cb476.cookieJar && (_0x1cb476.cookieJar = this.ckjar));
    }
    get(_0x197113, _0x194fcf = () => {}) {
      switch (_0x197113.headers && (delete _0x197113.headers["Content-Type"], delete _0x197113.headers["Content-Length"], delete _0x197113.headers["content-type"], delete _0x197113.headers["content-length"]), _0x197113.params && (_0x197113.url += "?" + this.queryStr(_0x197113.params)), this.getEnv()) {
        ...
        default:
          ...
          this.isSurge() && this.isNeedRewrite && (_0x197113.headers = _0x197113.headers || {}, Object.assign(_0x197113.headers, _0x361a8c));
          $httpClient.get(_0x197113, (_0xb188c, _0x5b42d4, _0x24eeed) => {
            !_0xb188c && _0x5b42d4 && (_0x5b42d4.body = _0x24eeed, _0x5b42d4.statusCode = _0x5b42d4.status ? _0x5b42d4.status : _0x5b42d4.statusCode, _0x5b42d4.status = _0x5b42d4.statusCode);
        ...
        case "Quantumult X":
          ...
          this.isNeedRewrite && (_0x197113.opts = _0x197113.opts || {}, Object.assign(_0x197113.opts, _0x46b1b8));
          ...
          this.got(_0x197113).on("redirect", (_0x32becf, _0x554448) => {
            try {
              if (_0x32becf.headers["set-cookie"]) {
                ...
                _0x36f9bd && this.ckjar.setCookieSync(_0x36f9bd, null);
    ...
    post(_0x31bfd1, _0x91da15 = () => {}) {
      ...
      switch (_0x31bfd1.body && _0x31bfd1.headers && !_0x31bfd1.headers["Content-Type"] && !_0x31bfd1.headers["content-type"] && (_0x31bfd1.headers["content-type"] = "application/x-www-form-urlencoded"), _0x31bfd1.headers && (delete _0x31bfd1.headers["Content-Length"], delete _0x31bfd1.headers["content-length"]), this.getEnv()) {
        ...
        default:
          ...
          this.isSurge() && this.isNeedRewrite && (_0x31bfd1.headers = _0x31bfd1.headers || {}, Object.assign(_0x31bfd1.headers, _0x5d683e));
          $httpClient[_0x6ba099](_0x31bfd1, (_0x38ef4f, _0x539903, _0x4351df) => {
            !_0x38ef4f && _0x539903 && (_0x539903.body = _0x4351df, _0x539903.statusCode = _0x539903.status ? _0x539903.status : _0x539903.statusCode, _0x539903.status = _0x539903.statusCode);
        ...
        case "Quantumult X":
          ...
          this.isNeedRewrite && (_0x31bfd1.opts = _0x31bfd1.opts || {}, Object.assign(_0x31bfd1.opts, _0x1190f7));
    ...
    time(_0x7d59d1, _0x841f2e = null) {
      ...
      /(y+)/.test(_0x7d59d1) && (_0x7d59d1 = _0x7d59d1.replace(RegExp.$1, (_0x592441.getFullYear() + "").substr(4 - RegExp.$1.length)));
      for (let _0x18cded in _0x2f2ebd) new RegExp("(" + _0x18cded + ")").test(_0x7d59d1) && (_0x7d59d1 = _0x7d59d1.replace(RegExp.$1, 1 == RegExp.$1.length ? _0x2f2ebd[_0x18cded] : ("00" + _0x2f2ebd[_0x18cded]).substr(("" + _0x2f2ebd[_0x18cded]).length)));
      return _0x7d59d1;
    }
    queryStr(_0x322703) {
      let _0x1b4b75 = "";
      for (const _0x248007 in _0x322703) {
        ...
        null != _0x28237e && "" !== _0x28237e && ("object" == typeof _0x28237e && (_0x28237e = JSON.stringify(_0x28237e)), _0x1b4b75 += _0x248007 + "=" + _0x28237e + "&");
      }
    ...
    msg(_0xbe78d4 = _0x34642e, _0x4f39f4 = "", _0x46e9a2 = "", _0xc6f15e) {
      ...
      if (!this.isMuteLog) {
        ...
        _0x4f39f4 && _0x49e8d7.push(_0x4f39f4);
        _0x46e9a2 && _0x49e8d7.push(_0x46e9a2);
        console.log(_0x49e8d7.join("\n"));
        this.logs = this.logs.concat(_0x49e8d7);
      }
    }
    log(..._0x5f48bc) {
      _0x5f48bc.length > 0 && (this.logs = [...this.logs, ..._0x5f48bc]);
